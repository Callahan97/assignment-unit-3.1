...
let favoriteFoods = ['Brisket', 'Short Ribs', 'Okra'];
...
console.log('Added my favorite dessert', favoriteFoods);
...
let entree = 'Tortellini Alla Panna';
favoriteFoods.unshift(entree);
console.log(`Added my favorite pasta instead of BBQ: ${favoriteFoods}`);
